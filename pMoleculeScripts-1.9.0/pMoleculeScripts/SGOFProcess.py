...
if HasMultiprocessing:
    ...
    class SGOFProcessMultiprocessing ( object ):
...
#===================================================================================================================================
    def SGOFProcessMultiprocessingScript ( objectiveFunction, receiver, sender ):
        ...
        # . Initialization.
        g = Real1DArray ( objectiveFunction.NumberOfVariables ( ) ) ; g.Set ( 0.0 )
        # . Poll for tasks.
        while True:
            if receiver.poll ( ):
