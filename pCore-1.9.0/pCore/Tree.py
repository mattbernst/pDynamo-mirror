...
class TreeBranchNode ( TreeNode ):
    ...
    defaultAttributes = { "children"   : None ,
                          "childIndex" : None }
    defaultAttributes.update ( TreeNode.defaultAttributes )

    def __init__ ( self, **keywordArguments ):
        """Constructor."""
        super ( TreeBranchNode, self ).__init__ ( **keywordArguments )
        self.Initialize ( )
...
class TreeRootNode ( TreeBranchNode ):
    ...
    defaultAttributes = { "defaultLabel"   : _DefaultLabel   ,
