...
class Timings ( defaultdict ):
    ...
    def __init__ ( self, *arguments, **keywordArguments ):
        """Constructor."""
        super ( Timings, self ).__init__ ( float, *arguments, **keywordArguments )

    def Accumulate ( self, other ):
        """Accumulation."""
        for ( key, value ) in other.iteritems ( ): self[key] += value
...
class TimingsAverager ( Timings ):
    ...
    def __init__ ( self, *arguments, **keywordArguments ):
        """Constructor."""
        super ( TimingsAverager, self ).__init__ ( *arguments, **keywordArguments )
    ...
    def Summary ( self, **keywordArguments ):
        """Summary."""
        if self.numberOfSamples <= 0: raise ValueError ( "The averager has no samples to summarize." )
        super ( TimingsAverager, self ).Summary ( **keywordArguments )
