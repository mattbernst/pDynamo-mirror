...
from pCore import logFile, LogFileActive, MoreThuenteLineSearcher, TestCase, UniDimensionalObjectiveFunction
...
class TestFunction1 ( TestFunction ):
    ...
    defaultAttributes = { "beta" : 2.0 }
    defaultAttributes.update ( TestFunction.defaultAttributes )
...
# . Class.
#===================================================================================================================================
class MoreThuenteTest ( TestCase ):
    """Test the More-Thuente line search algorithm."""
    ...
    def runTest ( self ):
        ...
        for ( i, ( functionClass, attributes, functionTolerance, gradientTolerance ) ) in enumerate ( _FunctionData ):
            ...
            for initialStep in _InitialSteps:
                mt = MoreThuenteLineSearcher ( functionTolerance            = functionTolerance ,
