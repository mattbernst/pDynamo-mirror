	...
	for y in Vr:
	    ...
	    for z in reduced.adjacentNodes.get ( y, [] ):
		    ...
		    zPath     = paths[z]
		        ...
		        s.append ( z )
			try: digraph.AddEdge ( Edge ( y, z ) )
			except: pass

                    # . Odd cycle - P(r,z) + (z,y) + P(y,r).
        	    elif ( reduced.nodeIndex[z] < reduced.nodeIndex[y] ) and ( zDistance != yDistance + 1 ) and _PathIntersectsAt ( yPath, zPath, r ):
