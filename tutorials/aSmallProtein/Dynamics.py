...
for pdbPath in _PDBPaths:
    ...
    for structure in _Structures:
        ...
        trajectory = AmberTrajectoryFileWriter ( os.path.join ( outPath, pdbPath + "_" + structure + "_md1.crd" ), system )
        ...
        XYZFile_FromSystem ( os.path.join ( outPath, pdbPath + "_" + structure + "_md1.xyz" ), system )
