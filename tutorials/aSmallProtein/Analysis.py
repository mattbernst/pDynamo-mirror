...
for pdbPath in _PDBPaths:
    ...
    for structure in _Structures:
        ...
        protein = Selection.FromIterable ( AtomSelection.FromAtomPattern ( system, "A:*:*" ) )
        ...
        # . Get the trajectory.
        trajectory = AmberTrajectoryFileReader ( os.path.join ( outPath, pdbPath + "_" + structure + "_md1.crd" ), system )
        ...
        while trajectory.RestoreOwnerData ( ):
            ...
            rms.append ( system.coordinates3.RMSDeviation     ( reference3, selection = protein, weights = masses ) )
