"""Example 26 - Lennard-Jones perturbation."""
...
# . Read in the system.
solution = Unpickle ( os.path.join ( scratchPath, "Example26Q.pkl" ) )
solution.Summary ( )
...
for i in range ( NLAMBDAS - 1, -1, -1 ):
    ...
    MonteCarlo_ScaleIsolateInteractionParameters ( solution, SOLUTE, chargeScale = 0.0, epsilonScale = LAMBDA, sigmaScale = LAMBDA )
    ...
    MonteCarlo_SystemGeometry ( solution                                      ,
                                ...
                                volumeFrequency       = VOLUMEFREQUENCY       )
    ...
    while mcData.RestoreOwnerData ( ):
        ...
        if i > 0:
            MonteCarlo_ScaleIsolateInteractionParameters ( solution, SOLUTE, chargeScale = 0.0, epsilonScale = LAMBDA - DLAMBDA, sigmaScale = LAMBDA - DLAMBDA )
