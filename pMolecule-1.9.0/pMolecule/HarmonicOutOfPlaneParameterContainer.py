#-------------------------------------------------------------------------------
# . File      : HarmonicOutOfPlaneParameterContainer.py
...
class HarmonicOutOfPlaneParameterContainer ( MMParameterContainer ):
    ...
    defaultAttributes = { "itemsWild" : None }
    defaultAttributes.update ( MMParameterContainer.defaultAttributes )

    defaultTermLabel = "Harmonic Out-Of-Plane"
...
#        except:
                ...
                if ( fC is None ) and hasWildCard:
                    ...
                    for to in toTry:
                        ...
                        if newFC is not None:
                            ...
                            numberFound += 1
                    # . Error - temporary.
                    if numberFound > 1: raise ValueError ( "Multiple terms found for {:s}-{:s}-{:s}-{:s}.".format ( ti, tj, tk, tl ) )
    ...
    def MakeMMTermsFromConnectivity ( self, atomTypeLabels, connectivity ):
        ...
        termIndices = connectivity.GetPlanarAtomIndices ( )
    ...
    def ProcessRawItems ( self ):
        ...
        # . Process entries.
            ...
            if wildCard is None:
                ...
                items     = {}
                itemsWild = {}
                for ( key, value ) in self.rawItems.iteritems ( ):
