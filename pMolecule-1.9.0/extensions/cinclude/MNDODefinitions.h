...
# define SMALL_RIJ  5.0e-3
# define SMALL_RIJ2 2.0e-5
...
/* . The maximum number of unique one-center two-electron integrals - 1 (s), 16 (sp). */
# define N1CTEIS 16

/* . The maximum number of two-center two-electron integrals - 1 (s), 100 (sp). */
# define N2CTEIS 100

# endif /* NOT MNDODORBITALS */
