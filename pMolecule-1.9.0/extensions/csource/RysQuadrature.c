...
static void RysSymmetricMatrix ( Real c[][MAXRYS+1], Real s[][MAXRYS+1], const Integer n ) ;
...
static void Roots6Plus ( RysQuadrature *roots, Integer mroots, Real yy )
{
    ...
    Real a[MAXRYS+1], c[MAXRYS+1][MAXRYS+1], ff[2*(MAXRYS+1)], r[MAXRYS][MAXRYS], rt[MAXRYS+1], s[MAXRYS+1][MAXRYS+1], w[MAXRYS][MAXRYS] ;
...
static void RysSymmetricMatrix ( Real c[][MAXRYS+1], Real s[][MAXRYS+1], const Integer n )
{
    Real dot, fac, v[MAXRYS+1], y[MAXRYS+1] ;
    Integer    i, j, k ;
