...
!-----------------------------------------------------------------------------*/
/*==============================================================================
! . This module has procedures for generating angular integration grids.
!
...
! . Private procedures.
!-----------------------------------------------------------------------------*/
/* . Find symmetry-related points. */
static Integer LebedevLaikov_Oh ( const Integer option, const Real a, const Real b, const Real v, Real *x, Real *y, Real *z, Real *w ) ;

/*------------------------------------------------------------------------------
! . Return the angular momentum value for a given number of points.
! . The value is rounded down.
!-----------------------------------------------------------------------------*/
int LebedevLaikov_Angular_Momentum_Value ( const Integer npts )
{
    Integer lvalue = 0;
         if ( npts <=    6 ) lvalue =   3 ;
    else if ( npts <=   14 ) lvalue =   5 ;
    else if ( npts <=   26 ) lvalue =   7 ;
    else if ( npts <=   38 ) lvalue =   9 ;
    else if ( npts <=   50 ) lvalue =  11 ;
    else if ( npts <=   74 ) lvalue =  13 ;
    else if ( npts <=   86 ) lvalue =  15 ;
    else if ( npts <=  110 ) lvalue =  17 ;
    else if ( npts <=  146 ) lvalue =  19 ;
    else if ( npts <=  170 ) lvalue =  21 ;
    else if ( npts <=  194 ) lvalue =  23 ;
    else if ( npts <=  230 ) lvalue =  25 ;
    else if ( npts <=  266 ) lvalue =  27 ;
    else if ( npts <=  302 ) lvalue =  29 ;
    else if ( npts <=  350 ) lvalue =  31 ;
    else if ( npts <=  434 ) lvalue =  35 ;
    else if ( npts <=  590 ) lvalue =  41 ;
    else if ( npts <=  770 ) lvalue =  47 ;
    else if ( npts <=  974 ) lvalue =  53 ;
    else if ( npts <= 1202 ) lvalue =  59 ;
    else if ( npts <= 1454 ) lvalue =  65 ;
    else if ( npts <= 1730 ) lvalue =  71 ;
    else if ( npts <= 2030 ) lvalue =  77 ;
    else if ( npts <= 2354 ) lvalue =  83 ;
    else if ( npts <= 2702 ) lvalue =  89 ;
    else if ( npts <= 3074 ) lvalue =  95 ;
    else if ( npts <= 3470 ) lvalue = 101 ;
    else if ( npts <= 3890 ) lvalue = 107 ;
    else if ( npts <= 4334 ) lvalue = 113 ;
    else if ( npts <= 4802 ) lvalue = 119 ;
    else if ( npts <= 5294 ) lvalue = 125 ;
    else if ( npts <= 5810 ) lvalue = 131 ;
    return lvalue ;
}

/*------------------------------------------------------------------------------
! . Return the number of points for a given angular momentum value.
!-----------------------------------------------------------------------------*/
int LebedevLaikov_Number_Of_Points ( const Integer lvalue )
{
  Integer fraction, npts = 0, tmp_lvalue ;
  tmp_lvalue = lvalue ;
  if ( lvalue < 3 ) npts = 6 ; /* . Small grids.*/
  else if ( lvalue <= 31 )     /* . Grids complete through l = 2m+1. */
  {
      tmp_lvalue -= 1;
      fraction    = tmp_lvalue%2 ;
      tmp_lvalue /= 2 ;
      if ( fraction != 0 ) tmp_lvalue++ ;
      switch ( tmp_lvalue )
      {
         case  0: npts =   6 ; break ;
         case  1: npts =   6 ; break ;
         case  2: npts =  14 ; break ;
         case  3: npts =  26 ; break ;
         case  4: npts =  38 ; break ;
         case  5: npts =  50 ; break ;
         case  6: npts =  74 ; break ;
         case  7: npts =  86 ; break ;
         case  8: npts = 110 ; break ;
         case  9: npts = 146 ; break ;
         case 10: npts = 170 ; break ;
         case 11: npts = 194 ; break ;
         case 12: npts = 230 ; break ;
         case 13: npts = 266 ; break ;
         case 14: npts = 302 ; break ;
         case 15: npts = 350 ; break ;
      }
   }
   else if ( lvalue <= 131 ) /* . Grids complete through l = 6m+5. */
   {
      tmp_lvalue -= 5;
      ...
      switch ( tmp_lvalue )
      {
         case  5: npts =  434 ; break ;
         case  6: npts =  590 ; break ;
         case  7: npts =  770 ; break ;
         case  8: npts =  974 ; break ;
         case  9: npts = 1202 ; break ;
         case 10: npts = 1454 ; break ;
         case 11: npts = 1730 ; break ;
         case 12: npts = 2030 ; break ;
         case 13: npts = 2354 ; break ;
         case 14: npts = 2702 ; break ;
         case 15: npts = 3074 ; break ;
         case 16: npts = 3470 ; break ;
         case 17: npts = 3890 ; break ;
         case 18: npts = 4334 ; break ;
         case 19: npts = 4802 ; break ;
         case 20: npts = 5294 ; break ;
         case 21: npts = 5810 ; break ;
      }
   }
   return npts ;
}
...
/*------------------------------------------------------------------------------
! . Return the points for a given angular momentum value.
!-----------------------------------------------------------------------------*/
#define A n+=LebedevLaikov_Oh(
#define B ,X+n,Y+n,Z+n,W+n);
int LebedevLaikov_Points ( const Integer N, double* X, double* Y, double* Z, double* W )
{
  Integer n;
  n = 0;
  switch ( N ) {
...
static Integer LebedevLaikov_Oh ( const Integer option, const Real a, const Real b, const Real v, Real *x, Real *y, Real *z, Real *w )
{
   ...
   switch ( option )
   {
      case 1: /* . Vertices of the octahedron. */
         A = 1.0 ;
         ...
         npts = 6 ;
         break ;
      case 2: /* . Midpoints of the edges of the octahedron. */
         A = 1.0 / sqrt ( 2.0 ) ;
