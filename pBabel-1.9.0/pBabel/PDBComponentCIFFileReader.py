#-------------------------------------------------------------------------------
# . File      : PDBComponentCIFFileReader.py
...
#===================================================================================================================================
# . Bond strings.
_BondStrings = { "AROM" : AromaticSingleBond ( ), "DOUB" : DoubleBond ( ), "SING" : SingleBond ( ), "TRIP" : TripleBond ( ) }
            ...
            try:
                ...
                while True:
                    ...
                    # . Header.
                        ...
                        self.active = PDBComponent ( label = line[5:] )
                        QLOOP    = False
                        QWARNING = True
                    # . Atom block.
    ...
    def ParseBondBlock ( self, line, QLOOP ):
        ...
        if QLOOP:
            ...
            while True:
                ...
                if QBONDS:
                    tokens = self.ParseTokens ( line )
                    bonds.append ( PDBComponentBond ( atomLabel1 = tokens[index["atom_id_1"]],  \
                                                      atomLabel2 = tokens[index["atom_id_2"]],  \
                                                      bondType   = _BondStrings.get ( tokens[index["value_order"]], UndefinedBond ( ) ) ) )
                    # . Checking.
        ...
        # . Single bond.
            ...
            while True:
                ...
                elif tokens[0] == "_chem_comp_bond.value_order": bondType   = _BondStrings.get ( tokens[1], UndefinedBond ( ) )
                QFIRST = False
            bonds.append ( PDBComponentBond ( atomLabel1 = atomLabel1, atomLabel2 = atomLabel2, bondType = bondType ) )
        # . Finish up.
...
#type
    ...
    def ParseGeneralBlock ( self, line ):
        ...
        while True:
            ...
            QFIRST = False
        # . Finish up.
        if ( namelines ) > 0: name = " ".join ( namelines )
        else:                 name = None
        # . Save data.
...
#                print line.split ( )
    ...
    def ToComponents ( self ):
        ...
        if self.QPARSED: return self.components
        else:            return []

#===================================================================================================================================
# . Helper functions.
#===================================================================================================================================
def PDBComponentCIFFile_ToComponents ( cifPath, asDictionary = True, fullOutput = False, log = logFile ):
    """Helper function that reads components from a PDB chemical component file in mmCIF format."""
    # . Parse file.
    infile = PDBComponentCIFFileReader ( cifPath )
