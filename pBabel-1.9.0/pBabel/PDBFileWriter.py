...
# . Standard residues.
_STANDARDRESIDUES = set ( [ "ALA", "ARG", "ASN", "ASP", "ASX", "CYS", "GLN", "GLU", "GLX", "GLY", "HIS", "ILE", "LEU", "LYS", "MET", "PHE", "PRO", "SER", "THR", "TRP", "TYR", "UNK", "VAL", \
                            "A", "+A", "C", "+C", "G", "+G", "I", "+I", "T", "+T", "U", "+U", "UNK" ] )
...
class PDBFileWriter ( TextFileWriter ):
    ...
    def WriteSystem ( self                           ,
        ...
        # . Author.
        self.file.write ( _AUTHORLINEFORMAT.format ( "AUTHOR", "GENERATED BY PDYNAMO", PDYNAMO_VERSION ) )
        # . Compound.
...
_Exporter.AddHandler ( { System : PDBFile_FromSystem } , [ "ent", "ENT", "pdb", "PDB" ], "Protein Data Bank" )
