...
from pCore        import Coordinates3, logFile, LogFileActive, Selection, TextFileReader, Vector3
...
_MULTIPLICITIES = set ( [ "SINGLET", "DOUBLET", "TRIPLET", "QUARTET", "QUINTET", "SEXTET", "SEPTET" ] )
...
class MopacInputFileReader ( TextFileReader ):
    ...
    def _ParseKeywords ( self ):
        ...
        # . Multiplicity.
        multiplicities = list ( keywords.intersection ( _MULTIPLICITIES ) )
        multiplicities.sort ( )
