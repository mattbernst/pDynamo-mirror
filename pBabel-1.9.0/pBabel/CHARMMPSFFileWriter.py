...
from pCore        import Selection, TextFileWriter
from ExportImport import _Exporter
from pMolecule    import CMAPDihedralContainer, FourierDihedralContainer, HarmonicAngleContainer, HarmonicBondContainer, HarmonicImproperContainer, Sequence, System
...
class CHARMMPSFFileWriter ( TextFileWriter ):
    ...
    def PrepareSystemData ( self, system, hasCHEQ ):
        ...
        # . Fixed atoms.
        fixedAtoms = None
        if system.hardConstraints is not None:
            if system.hardConstraints.NumberOfFixedAtoms ( ) > 0:
                fixedAtoms = system.hardConstraints.fixedAtoms
        if fixedAtoms is None: fixedAtoms = set ( )
        # . Atom data.
        try:
            # . Basic data.
        ...
        # . Sequence.
        if system.sequence is None: sequence = Sequence.FromAtomContainer ( system.atoms, componentLabel = "UNK.1", entityLabel = "UNK" )
...
# . Helper functions.
#===================================================================================================================================
def CHARMMPSFFile_FromSystem ( path, system, extendedFormat = True, hasCHEQ = True, isXPLOR = True ):
...
_Exporter.AddHandler ( { System : CHARMMPSFFile_FromSystem } , [ "psf", "psfx", "PSF", "PSFX" ], "Charmm PSF" )
